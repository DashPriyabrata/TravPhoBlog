...
//app.controller('SocialConnectController', function (socialConnectService, $scope) {
//    'use strict';
...
app.controller('SocialConnectController', ['socialConnectService', '$scope', SocialConnectController]);
